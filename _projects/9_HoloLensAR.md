...
<!-- Project Overview -->
<div>
    <h2 class="mt-5 font-weight-bold">Project Overview</h2>
    <p class="mt-3"><b class="font-weight-bold">Project Name:</b> Designing AR HMI Controls for Robotic Systems</p>
    <p><b class="font-weight-bold">My Role:</b> Interaction Designer & Interface Developer</p>
    <p><b class="font-weight-bold">Core Technologies:</b> Unity3D (C#), AR Interface Design, Spatial Gestural Interaction, Haptic Feedback (Arduino, C++)</p>
</div>

<!-- Problem & Challenge -->
<div>
    <h2 class="mt-5 font-weight-bold">Problem & Challenge</h2>
    ...
    <ul>
        <li><b class="font-weight-bold">Spatial Interaction</b></li>
        ...
        <li><b class="font-weight-bold">Information Overlay</b></li>
        ...
        <li><b class="font-weight-bold">The Haptic Gap</b></li>
...
<div>
    <h2 class="mt-5 font-weight-bold">My Process & Contributions</h2>
    <p class="mt-3"> 
    I led the interaction design and development for this project's short-term goal: to <b class="font-weight-bold">create an AR interface on HoloLens 2 to control a robotic arm.</b>
    </p>
    <p>
    ...
    <p>
    During the development process, I collaborated closely with our team's designer to create a <b class="font-weight-bold">user-friendly interface for both control and data visualization</b>. We also proactively addressed the issue of missing tactile feedback. We explored solutions for haptic feedback by utilizing an <b class="font-weight-bold">UltraHaptics device for ultrasonic feedback</b> and building a prototype based on the <b class="font-weight-bold">'Touch&Fold' paper for vibrational feedback</b>, enhancing user confidence and precision during control.
    </p>
    <!-- image -->
...
<!-- Outcome & Impact -->
<div>
    <h2 class="mt-5 font-weight-bold">Outcome & Impact</h2>
    <p>
