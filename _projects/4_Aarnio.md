...
paper: ACM CHI 19
author: Shan-Yuan Teng, Da-Yuan Huang, <span style='font-weight:900;'>Chi Wang</span>, Jun Gong, Teddy Seyed, Xing-Dong Yang, Bing-Yu Chen
---
...
<div>
    <h2 class="mt-5 font-weight-bold">Design</h2>
        <ul class="mt-3">
            ...
            <li><b style="font-weight:900;">Kinesthetic Force Feedback</b></li>
            ...
            <li><b style="font-weight:900;">Interaction Design Space</b></li>
            ...
            <div class="row justify-content-sm-center">
                ...
                <ul>
                    <!-- Components -->
                    <li><b style="font-weight:900;">Components:</b></li>
                    <ul>
                        <li><b style="font-weight:900;">Seat:</b> Modifying the natural resistance when rotating, sliding, or tilting the seat to provide dynamic feedback.</li>
                        <li><b style="font-weight:900;">Backrest:</b> Adjusting the tension of the backrest to provide information as a user reclines.</li>
                        <li><b style="font-weight:900;">Armrest & Headrest:</b> Using the natural mechanical resistance of these components to offer additional channels for haptic output.</li>
                        <li><b style="font-weight:900;">Casters:</b> Modulating the friction of the wheels to provide feedback while rolling.</li>
                    </ul>
                    <!-- Methodology -->
                    <li class="mt-2"><b style="font-weight:900;">Methodology:</b></li>
                    <ul>
                    ...
                    <!-- Results -->
                    <li class="mt-2"><b style="font-weight:900;">Results:</b></li>
                        <ul>
                            <li><b style="font-weight:900;">High-Potential Interactions:</b> Rotating, tilting, and rolling were the top-ranked movements, as they were well-balanced for both explicit and implicit input.</li>
                            <ul>
                                <li><b style="font-weight:900;">Tilting the backrest:</b> Over 65% of participants preferred this action, describing it as "physically effortless" and "natural to perform."</li>
                                <li><b style="font-weight:900;">Rolling the chair:</b> This was preferred more for implicit input than explicit, as participants often make these movements unconsciously to adjust for comfort.</li>
                                <li><b style="font-weight:900;">Rotating the seat:</b> This was preferred more for explicit input, as participants found it unlikely to rotate the seat unintentionally.</li>
                            </ul>
                             <li><b style="font-weight:900;">Other Findings:</b></li>
                            <ul>
                                <li><b style="font-weight:900;">Armrest rotation: </b> Considered suitable only for explicit input.</li>
                                <li><b style="font-weight:900;"> Vertical seat movement:</b> Found to be suitable only for implicit input, as it naturally provides haptic information when a user sits down.</li>
                            </ul>
                        </ul>
                    <!-- Conclusion -->
                    <li class="mt-2"><b style="font-weight:900;">Conclusion:</b></li>
...
<!-- Prototype -->
<div>
    <h2 class="mt-5 font-weight-bold">Prototype</h2>
        <p>Based on the results of the informal study, we created a prototype to demonstrate the proposed haptic output. Our prototype was created by augmenting the <b style="font-weight:900;">seat</b>, <b style="font-weight:900;">backrest</b>, and <b style="font-weight:900;">caster</b> of the Swivel office chair. We extended the natural resistive forces of the joints of the chair using carefully designed braking and tilt tension controlling systems.</p>
        <!-- image -->
        <div class="row justify-content-sm-center">
        ...
        <ul>
            <li><b style="font-weight:900;">Profiles for Rotating the Seat:</b></li>
                <ul>
                    <li><b style="font-weight:900;">Natural Resistance: </b></li>
                    This profile provides the chair's inherent light friction, without any added resistance from the haptic system.
                    <li><b style="font-weight:900;">Strong Resistance: </b></li>
                    ...
                    <li><b style="font-weight:900;">Click: </b></li>
            ...
            <li><b style="font-weight:900;">Profiles for Tilting the Backrest:</b></li>
                <ul>
                    <li><b style="font-weight:900;">Minimum Tension: </b></li>
                    The backrest offers the lowest resistance, making it effortless for the user to initiate a recline.
                    <li><b style="font-weight:900;">Low Tension: </b></li>
            ...
            <li><b style="font-weight:900;">Profiles for Rolling the Chair:</b></li>
                <ul>
                    <li><b style="font-weight:900;">Natural Resistance: </b></li>
...
<div>
    ...
    <ul>
        <li><b style="font-weight:900;">Experimental Method</b></li>
            <ul>
                <li><b style="font-weight:900;">Tasks:</b></li>
                    <ul>
                        <li><b style="font-weight:900;">Primary Task:</b> Participants were asked to identify the force profiles presented through reclining, rotating the seat, or rolling the chair. They could repeat the movement as many times as needed but were not allowed to reverse the motion.</li>
                        <li><b style="font-weight:900;">Secondary Task (Cognitive Load):</b> In half the trials, participants performed a modified Stroop test to simulate a distracted state. They had to maintain over 90% accuracy by counting the number of times a word's text and font color matched.</li>
                    </ul>
                <li><b style="font-weight:900;">Experimental Design:</b></li>
                 ...
                 <li><b style="font-weight:900;">Measures:</b></li>
                    <ul>
                        <li><b style="font-weight:900;">Recognition Accuracy:</b> The number of correctly identified force profiles.</li>
                        <li><b style="font-weight:900;">Response Time:</b> The time from the start of the force profile to the key press.</li>
                        <li><b style="font-weight:900;">Number of Attempts: </b> The number of tries needed to identify a profile.</li>
                        <li><b style="font-weight:900;">Questionnaire: </b> After each study, participants rating the recognizability of the profiles on a continuous 1-7 scale.</li>
                    </ul>
            </ul>
        <li><b style="font-weight:900;">Results:</b></li>
            <ul>
                <li><b style="font-weight:900;">Profile Recognition Accuracy:</b></li>
                    <ul>
                        <li><b style="font-weight:900;">Rotation: </b>The force profiles were highly recognizable (93.8% accuracy). The Lock and Click profiles were the easiest to identify, while Ramp-Down was the most confusing. Cognitive load had no significant impact.</li>
                        <li><b style="font-weight:900;">Tilt: </b>Recognition was slightly more challenging (87.3% accuracy) and was significantly affected by cognitive load. Participants had difficulty distinguishing between similar tension levels.</li>
                        <li><b style="font-weight:900;">Rolling: </b>The profiles were highly recognizable (93.0% accuracy). Click had the highest accuracy, while Strong Resistance was the most confusing. Cognitive load had no significant impact.</li>
                    </ul>
                <li><b style="font-weight:900;">Response Time:</b></li>
                    <ul>
                        <li><b style="font-weight:900;">Average Times: </b>Rotation (4.25s), Tilt (6s), and Rolling (3.74s).</li>
                        <li><b style="font-weight:900;">Rotation and Rolling: </b>Click was the fastest to recognize, thanks to its distinct haptic landmark. Strong Resistance was the slowest.</li>
                        <li><b style="font-weight:900;">Counterintuitive Finding: </b>Under cognitive load, participants’ response times were significantly faster for both rotation and rolling. They reported speeding up to finish the cognitive task more quickly, but this did not compromise their accuracy.</li>
                    </ul>
                <li><b style="font-weight:900;">Number of Attempts & Subjective Ratings:</b></li>
                    <ul>
                        <li><b style="font-weight:900;">Number of Attempts: </b>Participants were highly confident in their answers, requiring an average of only 1.05 to 1.06 attempts to correctly identify a profile. Neither the cognitive load nor the force profile significantly affected the number of attempts.</li>
                        <li><b style="font-weight:900;">Subjective Ratings: </b>Participants' subjective ratings of recognizability were consistent with the quantitative accuracy results, confirming that they had a reliable sense of how easy or difficult each profile was to distinguish.</li>
                    </ul>
            </ul>
            <!-- image -->
...
<div>
    ...
    <div class="row justify-content-sm-center mt-3">
        ...
        <div class="col-sm-7 mt-3 mt-md-0">
            <ul>
                <li><b style="font-weight:900;">On-demand Information Acquisition</b></li>
                ...
                <li><b style="font-weight:900;">Hands-free Interactions</b></li>
                ...
                <li><b style="font-weight:900;">Gaming</b></li>
                ...
                <li><b style="font-weight:900;">Interaction Techniques for People with Disabilities</b></li>
