...
paper: ACM UIST 19
author: <span class="my-color-b" style='font-weight:900;'>Chi Wang</span>, Da-Yuan Huang, Shuo-Wen Hsu, Chu-En Hou, Yeu-Luen Chiu, Ruei-Che Chang, Jo-Yu Lo, Bing-Yu Chen
---
...
<div>
    ...
    <ul>
        <li class="font-weight-bold my-color-b">Objective & Method</li>
            <ul>
        ...
        <li class="font-weight-bold my-color-b">Results</li>
            <ul>
                <li><b class="my-color-b" style="font-weight:900;">Statistical Analysis</b></li>
                ...
                <li><b class="my-color-b" style="font-weight:900;">Size Preference</b></li>
    ...
    <p>Based on the statistical results and participant feedback, the final hardware prototype was designed using <b class="my-color-b" style="font-weight:900;">30mm-diameter</b>, <b class="my-color-b" style="font-weight:900;">concave-shaped tactors</b>, which received the highest overall preference rating.</p>
    <!-- image -->
...
<div>
    ...
    <ul>
        <li class="font-weight-bold my-color-b">EVALUATING PHYSICAL COMFORT</li>
            <ul>
        ...
        <li class="font-weight-bold my-color-b">DISTANCE JND (Just Noticeable Difference)</li>
            <ul>
        ...
        <li class="font-weight-bold my-color-b">ANGLE DISCRIMINATION</li>
            <ul>
...
<div>
    ...
    <ul>
        <li class="font-weight-bold my-color-b">Application 1: Motorcycle Racing</li>
            <ul>
        ...
        <li class="font-weight-bold my-color-b">Application 2: Snowball Fight</li>
            <ul>
                <li>Impact of a direct hit</li>
                <li>The subtle graze of a near miss</li>
            </ul>
        <li class="font-weight-bold my-color-b">Application 3: Virtual Museum Guidance</li>
            <ul>
    ...
    <ul>
        ...
        <li class="font-weight-bold my-color-b">Participants & Task</li>
            <ul>
        ...
        <li class="font-weight-bold my-color-b">Key Findings</li>
            <ul>
                <li class="font-weight-bold my-color-b mt-2">Realism</li>
                    <ul>
                        <li class="font-weight-bold my-color-b">Motorcycle Racing</li>
                        ...
                        <li class="font-weight-bold my-color-b">Snowball Fight</li>
                ...
                <li class="font-weight-bold my-color-b">Enjoyment</li>
                    <ul>
                        <li class="font-weight-bold my-color-b">Games (Motorcycle Racing & Snowball Fight)</li>
                        ...
                        <li class="font-weight-bold my-color-b">Virtual Museum Guidance</li>
