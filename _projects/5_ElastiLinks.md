...
paper: ACM UIST 20
author: Tzu-Yun Wei, Hsin-Ruey Tsai, Yu-So Liao, Chieh Tsai, Yi-Shan Chen, <span class="my-color-b" style='font-weight:900;'>Chi Wang</span>, Bing-Yu Chen
---
...
<div>
    <h2 class="mt-5 font-weight-bold my-color-b">Design</h2>
        ...
        <ul>
            <li><b class="my-color-b" style="font-weight:900;">Considerations</b></li>
                <ul>
                    ...
                    <li class="font-weight-bold my-color-b">Versatility</li> 
                    ...
                    <li class="font-weight-bold my-color-b">Comfort and Safety</li> 
                    The force output is carefully limited to a safe and comfortable range to prevent user injury or discomfort.
                    <li class="font-weight-bold my-color-b">Mobility</li> 
                ...
                <li class="mt-2"><b class="my-color-b" style="font-weight:900;">Hardware</b></li>
                    <ul>
                        <div class="row">
                            <div class="col-md-7">
                            <li class="font-weight-bold my-color-b">Main Components</li> 
                            ...
                            <li class="font-weight-bold my-color-b">Force Links</li> 
                                <ul>
                                    <li class="font-weight-bold my-color-b">Resistive Link</li> 
                                    ...
                                    <li class="font-weight-bold my-color-b">Impact Link</li> 
                        ...
                        <li class="font-weight-bold my-color-b">Dynamic PAF Mechanism</li> 
                        ...
                        <li class="font-weight-bold my-color-b">Features</li> 
                            <ul>
                                <li class="font-weight-bold my-color-b">Wire Brakes</li> 
                                ...
                                <li class="font-weight-bold my-color-b">Weight</li> 
                                The total weight is 750g (without Vive trackers), with one controller weighing 350g and the other 400g.
                            </ul>
                    </ul>
            <li><b class="my-color-b" style="font-weight:900;">Operation</b></li>
                <ul>
                    <li class="font-weight-bold my-color-b">Initialization</li> 
                    ...
                    <li class="font-weight-bold my-color-b">Resistive Force Delivery</li> 
                    ...
                    <li class="font-weight-bold my-color-b">Impact Delivery</li> 
                    ...
                    <li class="font-weight-bold my-color-b">Limitations</li> 
...
<div>
    ...
    <ul>
        <li><b class="my-color-b" style="font-weight:900;">Methodology</b></li>
            <ul>
        ...
        <li><b class="my-color-b" style="font-weight:900;">Findings</b></li>
            <ul>
                <li><b class="my-color-b" style="font-weight:900;">Force Level Distinguishability (Study 1)</b></li>
                    <ul>
                        <li><b class="my-color-b" style="font-weight:900;">Resistive Force & Impact:</b></li>
                        Users could clearly distinguish between all three tested levels for both resistive force and impact.
                        <li><b class="my-color-b" style="font-weight:900;">Application Note</b></li>
                ...
                <li><b class="my-color-b" style="font-weight:900;">PAF Distinguishability (Study 2)</b></li>
                    <ul>
                        <li><b class="my-color-b" style="font-weight:900;">Resistive Force</b></li>
                        ...
                        <li><b class="my-color-b" style="font-weight:900;">Impact</b></li>
...
<div>
    ...
    <ul>
        <li class="font-weight-bold my-color-b">Methodology</li>
            <ul>
                <li>Participants: 12 participants (5 female), all with prior VR experience.</li>
                <li><b class="font-weight-bold my-color-b">Survival Shooter Game: </b>For bimanual interactions (e.g., using a bow and rifle).</li>
                <li><b class="font-weight-bold my-color-b">Fighting Game: </b>For body-grounded interactions (e.g., with a controller attached to the arm).</li>
                <li><b class="font-weight-bold my-color-b">Fishing Game: </b>For environment-grounded interactions (e.g., with one controller fixed to a desk).</li>
            </ul>
        <li class="font-weight-bold my-color-b">Evaluation</li>
        ...
        <li class="font-weight-bold my-color-b">Key Finding</li>
            <ul>
                <li class="font-weight-bold my-color-b">Survival Shooter Game</li>
                ...
                <li class="font-weight-bold my-color-b">Fighting Game</li>
