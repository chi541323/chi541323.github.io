...
paper: ACM CHI 20
author: <span class="my-color-b" style='font-weight:900;'>Chi Wang</span>, Da-Yuan Huang, Shuo-Wen Hsu, Cheng-Lung Lin, Yeu-Luen Chiu, Chu-En Hou, Bing-Yu Chen
---
...
<div>
    ...
    <ul>
        <li class="font-weight-bold my-color-b">How well can participants discriminate skin stretch distances?</li>
        <li class="font-weight-bold my-color-b">How well can participants discriminate skin stretch angles?</li>
    </ul>

    <p><b class="my-color-b" style="font-weight:900;">Stretch Distance:</b> ANOVA showed a significant main effect of distance, indicating that participants could reliably discriminate larger distances from smaller ones.</p>
    <p><b class="my-color-b" style="font-weight:900;">Stretch Angle:</b> ANOVA revealed a significant effect of angle, suggesting that participants were also sensitive to directional differences.</p>
   ...
   <div class="row align-items-center">
        ...
        <div class="col-md-7">
            <ul>
                <li><b class="my-color-b" style="font-weight:900;">Exploratory Phase: </b> Prior to finalizing the design, we conducted informal tests to identify the most comfortable and perceivable skin contact areas on the legs.</li>
                <li><b class="my-color-b" style="font-weight:900;">Hardware: </b> The gaiters were lightweight and flexible, allowing them to be worn over clothing without restricting walking movements.</li>
                <li><b class="my-color-b" style="font-weight:900;">Feedback Control: </b> The tactors provided both continuous stretch (e.g., simulating inertia or slopes) and event-based cues (e.g., simulating impacts or environmental changes).</li>
            </ul>
        </div>
    </div>
</div>
...
<div>
    ...
    <p>The aim of this exploratory study is to test these action-coupled profiles and to understand how to utilize them to induce different types of perceptions. The action-coupled study evaluated <b class="my-color-b" style="font-weight:900;">six stretch profiles (Upward, Downward, Forward, Backward, Leftward, Rightward)</b> across <b class="my-color-b" style="font-weight:900;">three leg actions (Standing, Walking, Kicking)</b> to investigate four perceptual categories: Pulling Force, Weight, Rotational Force, and Friction. </p>
    <ul>
        <li class="font-weight-bold my-color-b">Objective</li>
            <ul>
        ...
        <li class="font-weight-bold my-color-b">Study Design</li>
            <ul>
                <li class="font-weight-bold my-color-b">Leg Actions</li>
                Participants performed three common VR actions: Standing, Walking, and Kicking.
                <li class="font-weight-bold my-color-b">Skin Stretch Profiles</li>
                Six directional profiles were tested: Upward, Downward, Forward, Backward, Leftward, and Rightward.
                <li class="font-weight-bold my-color-b">Perception Assessment</li>
        ...
        <li class="font-weight-bold my-color-b">Key Finding</li>
            <ul>
                <li class="font-weight-bold my-color-b">Pulling Force</li>
                ...
                <li class="font-weight-bold my-color-b">Leg Weight</li>
                ...
                <li class="font-weight-bold my-color-b">Rotational Force</li>
                ...
                <li class="font-weight-bold my-color-b">Friction</li>
...
<div>
    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-7">
                <ul>
                    <li class="font-weight-bold my-color-b">Application 1: Horror Escape Game</li>
                        <ul>
                    ...
                    <li class="font-weight-bold my-color-b mt-5">Application 2: Fancy Goal Game</li>
                        <ul>
    ...
    <ul>
        ...
        <li class="font-weight-bold my-color-b">Task</li>
            <ul>
        ...
        <li class="font-weight-bold my-color-b">Key Finding</li>
            <ul>
                <li class="font-weight-bold my-color-b">Horror Escape Game</li>
                    <ul>
                        <li class="font-weight-bold my-color-b">Realism</li>
                        ...
                        <li class="font-weight-bold my-color-b">Enjoyment</li>
                ...
                <li class="font-weight-bold my-color-b">Fancy Goal Game</li>
                    <ul>
                        <li class="font-weight-bold my-color-b">Realism & Enjoyment</li>
                        ...
                        <li class="font-weight-bold my-color-b">Design Implication</li>
